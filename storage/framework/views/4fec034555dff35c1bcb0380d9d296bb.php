  ...
  <div class="body">
    ...
    <div class="brand-stats">
      <div class="bstat bstat-blue" style="--i:0">
        ...
        <div class="bstat-num" data-target="<?php echo e($brands->count()); ?>">0</div>
        <div class="bstat-lbl">Total Brand</div>
        <div class="bstat-sub sub-up"><i class="fa-solid fa-arrow-trend-up"></i> +<?php echo e($brands->where('created_at', '>=', now()->subMonth())->count()); ?> bulan ini</div>
      </div>
      <div class="bstat bstat-em" style="--i:1">
        <div class="bstat-ic"><i class="fa-solid fa-circle-dot"></i></div>
        <div class="bstat-num" data-target="<?php echo e($brands->where('status', 'Active')->count()); ?>">0</div>
      ...
      <div class="bstat bstat-amb" style="--i:2">
        ...
        <div class="bstat-num" data-target="<?php echo e($brands->where('status', 'Non Active')->count()); ?>">0</div>
      ...
      <div class="bstat bstat-rose" style="--i:3">
        ...
        <div class="bstat-num" data-target="<?php echo e($brands->sum('contents_count') ?? 0); ?>">0</div>
        <div class="bstat-lbl">Total Konten</div>
        <div class="bstat-sub sub-up"><i class="fa-solid fa-arrow-trend-up"></i> +<?php echo e($brands->where('created_at', '>=', now()->subMonth())->sum('contents_count') ?? 0); ?> bulan ini</div>
      </div>
    </div>
    ...
    <div class="table-card">
      <div class="table-card-head">
        <div class="tch-left">
          ...
          <div class="tch-count" id="brandCount"><?php echo e($brands->count()); ?> brand</div>
        </div>
        <div class="tch-right">
        ...
        <div class="table-wrapper">
          <table class="brand-table">
            ...
            <tbody id="brandTableBody">
              ...
              <tr onclick="openDetail(<?php echo e($brand->id); ?>)">
                <td>
                  <div class="brand-cell">
                    <div class="brand-avatar" style="background:#5897fe"><?php echo e($brand->name ? strtoupper(substr($brand->name, 0, 2)) : '??'); ?></div>
                    <div>
                      <div class="brand-name-text"><?php echo e($brand->name ?: 'Unnamed Brand'); ?> (ID: <?php echo e($brand->id); ?>)</div>
                      <div class="brand-created">Dibuat <?php echo e($brand->created_at ? $brand->created_at->format('M Y') : 'Unknown'); ?></div>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="pic-cell">
                    <div class="pic-ava"><?php echo e($brand->pic ? strtoupper(substr($brand->pic, 0, 2)) : '??'); ?></div>
                    <span class="pic-name"><?php echo e($brand->pic ?: 'No PIC'); ?></span>
                  </div>
                </td>
                <td style="color:var(--text-500);font-size:12.5px"><?php echo e($brand->contact ?: 'No Contact'); ?></td>
                <td>
                  <span class="content-count"><i class="fa-solid fa-film"></i> 0 konten</span>
                </td>
                <td>
                  <span class="status-pill <?php echo e($brand->status === 'Active' ? 'sp-active' : 'sp-inactive'); ?>">
                    <span class="status-dot"></span><?php echo e($brand->status ?: 'Unknown'); ?>

                  </span>
                </td>
                <td onclick="event.stopPropagation()">
                  <div class="row-actions">
                    <button class="act-btn act-detail" onclick="openDetail(<?php echo e($brand->id); ?>)" title="Detail"><i class="fa-solid fa-eye"></i></button>
                    <button class="act-btn act-edit"   onclick="openEdit(<?php echo e($brand->id); ?>)"   title="Edit"><i class="fa-solid fa-pen"></i></button>
                    <button class="act-btn act-del"    onclick="openDelete(<?php echo e($brand->id); ?>)" title="Hapus"><i class="fa-solid fa-trash-can"></i></button>
                  </div>
                </td>
              </tr>
              ...
              <tr style="background: #f8f9fa; font-weight: bold;">
                <td colspan="6" style="text-align: center; padding: 5px; font-size: 12px;">
                  Total brands displayed: <?php echo e($brands->count()); ?> | Database count: <?php echo e($brands->count()); ?>
...
let brands = <?php echo json_encode($brands, 15, 512) ?>;
...
let nextId = <?php echo e($brands->max('id') + 1); ?>;
let currentPage = 1;
const perPage = 8;
...
window.addEventListener('DOMContentLoaded', () => {
  animateCounters();
  // renderTable(); // DISABLED - Use server-side rendering only
  ...
  if (id) {
    ...
    .then(data => {
      ...
      if (data.success) {
        ...
        filteredBrands = [...brands];
        console.log('Calling filterTable...');
        filterTable();
        closeModal('formOverlay');
...
<?php /**PATH C:\xampp\htdocs\pageflowry\resources\views/admin/brand/index.blade.php ENDPATH**/ ?>