  ...
  <div class="card">
    ...
    <div class="form-panel">
      ...
      <div class="form-section active" id="form-login">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" id="fLogin">
          <?php echo csrf_field(); ?>
          <div class="field">
            <label>📧 Email</label>
            <div class="input-wrap">
              <span class="input-ico">✉️</span>
              <input type="email" name="email" placeholder="email@pageflowry.com" value="<?php echo e(old('email')); ?>" required autocomplete="email"/>
            </div>
          </div>
          <div class="field">
            <div class="field-row">
      ...
      <div class="form-section" id="form-register">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" id="fRegister">
          <?php echo csrf_field(); ?>
          <div class="field">
            <label>👤 Nama Lengkap</label>
            <div class="input-wrap">
              <span class="input-ico">🙍</span>
              <input type="text" name="name" placeholder="Nama lengkap kamu" value="<?php echo e(old('name')); ?>" required maxlength="100"/>
            </div>
          </div>
          <div class="field">
            <label>📧 Email</label>
            <div class="input-wrap">
              <span class="input-ico">✉️</span>
              <input type="email" name="email" placeholder="email@pageflowry.com" value="<?php echo e(old('email')); ?>" required/>
            </div>
          </div>
          <div class="field">
            <label>🔒 Password</label>
    ...
    <div class="visual-panel">
      ...
      <div class="vis-photo-wrap">
        ...
        <img
          class="vis-photo"
          id="visPhoto"
          src="<?php echo e(asset('images/login1.png')); ?>"
          alt="PAGEFLOWRY"
...
<script>
  ...
  // Laravel errors
  <?php if($errors->any()): ?>
    <?php if($errors->has('name') || $errors->has('role') || old('name')): ?>
      switchTab('register');
      const mR = document.getElementById('msg-register');
      mR.className = 'msg error'; mR.innerHTML = '⚠️ <?php echo e($errors->first()); ?>'; mR.style.display = 'flex';
    <?php else: ?>
      const mL = document.getElementById('msg-login');
      mL.className = 'msg error'; mL.innerHTML = '⚠️ <?php echo e($errors->first()); ?>'; mL.style.display = 'flex';
    <?php endif; ?>
  <?php endif; ?>
  <?php if(session('status')): ?>
    const sE = document.getElementById('msg-login');
    sE.className = 'msg success'; sE.innerHTML = '✅ <?php echo e(session("status")); ?>'; sE.style.display = 'flex';
  <?php endif; ?>
</script>
</body>
</html><?php /**PATH C:\xampp444\htdocs\laravel\pageflowry\resources\views/auth/login.blade.php ENDPATH**/ ?>