...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
   ...
   <a class="sb-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
    ...
    <a class="sb-item <?php echo e(request()->routeIs('production.index') ? 'active' : ''); ?>" 
...
</html><?php /**PATH C:\xampp\htdocs\pageflowry\resources\views/layouts/admin.blade.php ENDPATH**/ ?>