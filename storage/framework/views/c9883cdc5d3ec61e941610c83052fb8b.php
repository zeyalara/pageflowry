...
<title>Pageflowry — <?php echo $__env->yieldContent('page-title','Dashboard'); ?></title>
...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
   ...
   <a class="sb-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-house"></i></span>
      Dashboard
    </a>

    <div class="sb-group-label">Manajemen</div>
    <a class="sb-item <?php echo e(request()->routeIs('brands.index') ? 'active' : ''); ?>" href="<?php echo e(route('brands.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-tag"></i></span>
      Brand Management
    </a>
    <a class="sb-item <?php echo e(request()->routeIs('content-tasks.index') ? 'active' : ''); ?>" href="<?php echo e(route('content-tasks.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-list-check"></i></span>
      Daftar Tugas Konten
    </a>

    <div class="sb-group-label">Workflow</div>
    <a class="sb-item <?php echo e(request()->routeIs('production.index') ? 'active' : ''); ?>" href="<?php echo e(route('production.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-film"></i></span>
      Production
    </a>
    <a class="sb-item <?php echo e(request()->routeIs('revision.index', 1) ? 'active' : ''); ?>" href="<?php echo e(route('revision.index', 1)); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-rotate-left"></i></span>
      Revision
      <span class="sb-badge">4</span>
    </a>
    <a class="sb-item <?php echo e(request()->routeIs('approval.index') ? 'active' : ''); ?>" href="<?php echo e(route('approval.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-circle-check"></i></span>
      Approval
    </a>
    <a class="sb-item <?php echo e(request()->routeIs('publishing.index') ? 'active' : ''); ?>" href="<?php echo e(route('publishing.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-paper-plane"></i></span>
      Publishing
    </a>

    <div class="sb-group-label">Laporan</div>
    <a class="sb-item <?php echo e(request()->routeIs('analytics.index') ? 'active' : ''); ?>" href="<?php echo e(route('analytics.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-chart-line"></i></span>
      Analytics
    </a>
    <a class="sb-item <?php echo e(request()->routeIs('report.index') ? 'active' : ''); ?>" href="<?php echo e(route('report.index')); ?>">
      <span class="icon-wrap"><i class="fa-solid fa-file-chart-line"></i></span>
      Report
    </a>

    <div class="sb-group-label">Lainnya</div>
    <a class="sb-item <?php echo e(request()->routeIs('settings.index') ? 'active' : ''); ?>" href="<?php echo e(route('settings.index')); ?>">
...
<div class="main">
  ...
  <header class="topbar">
    <div class="tb-left">
     <div class="tb-page"><?php echo $__env->yieldContent('page-title','Dashboard'); ?></div>
...
</html><?php /**PATH C:\xampp444\htdocs\laravel\pageflowry\resources\views/layouts/admin.blade.php ENDPATH**/ ?>