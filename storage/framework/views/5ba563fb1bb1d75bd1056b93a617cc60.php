<?php $__env->startSection('page-title','Production'); ?>
...
<div>
  <div class="stat-row">
    <div class="stat-card sc-blue" style="--i:0">
      ...
      <div class="stat-val" data-target="<?php echo e($stats['total_production']); ?>"><?php echo e($stats['total_production']); ?></div>
    ...
    <div class="stat-card sc-vio" style="--i:1">
      ...
      <div class="stat-val" data-target="<?php echo e($stats['under_review']); ?>"><?php echo e($stats['under_review']); ?></div>
    ...
    <div class="stat-card sc-red" style="--i:2">
      ...
      <div class="stat-val" data-target="<?php echo e($stats['need_revision']); ?>"><?php echo e($stats['need_revision']); ?></div>
...
<div class="card tbl-card">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr data-id="<?php echo e($production['id']); ?>">
        <td>
          <input type="checkbox" class="row-checkbox" value="<?php echo e($production['id']); ?>" onchange="updateBulkActions()">
        </td>
        <td>
          <span class="td-name"><?php echo e($production['judul_konten']); ?></span>
        </td>
        <td>
          <span class="td-brand"><?php echo e($production['nama_brand']); ?></span>
        </td>
        <td><?php echo e($production['versi_video']); ?></td>
        <td><?php echo e($production['durasi_final']); ?></td>
        <td><?php echo e($production['catatan_produksi'] ?? '-'); ?></td>
        <td>
          <?php if($production['file_video']): ?>
            <button class="btn-preview" onclick="previewVideo('<?php echo e($production['id']); ?>', '<?php echo e($production['judul_konten']); ?>', '<?php echo e($production['versi_video']); ?>', '<?php echo e($production['durasi_final']); ?>', '<?php echo e($production['file_video']); ?>')">
        ...
        <td>
          <span class="pill <?php echo e($statusClasses[$production['status']] ?? 'p-prod'); ?>">
            <span class="pill-dot"></span>
            <?php echo e($statusLabels[$production['status']] ?? $production['status']); ?>

          </span>
        </td>
        <td>
          <div class="action-buttons">
            <button class="btn-action btn-preview-sm" onclick="previewVideo('<?php echo e($production['id']); ?>', '<?php echo e($production['judul_konten']); ?>', '<?php echo e($production['versi_video']); ?>', '<?php echo e($production['durasi_final']); ?>', '<?php echo e($production['file_video']); ?>')" title="Preview Video">
              <i class="fa-solid fa-eye"></i>
            </button>
            <?php if($production['file_video']): ?>
              <a href="<?php echo e(route('production.download', $production['id'])); ?>" class="btn-action btn-download" title="Download Video">
                <i class="fa-solid fa-download"></i>
              </a>
            <?php endif; ?>
            <a href="<?php echo e(route('revision.index', $production['content_task_id'])); ?>" class="btn-action btn-review" title="Review Konten">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pageflowry\resources\views/admin/production/index.blade.php ENDPATH**/ ?>