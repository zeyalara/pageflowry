...
<title>Pageflowry — Production</title>
...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a class="sb-item active" href="<?php echo e(route('production.index')); ?>"><span class="sb-ic"><i class="fa-solid fa-film"></i></span>Production</a>
    ...
    <a class="sb-item" href="<?php echo e(route('publishing.index')); ?>"><span class="sb-ic"><i class="fa-solid fa-paper-plane"></i></span>Publishing</a>
...
<div class="main">
  <header class="topbar">
    <div>
      <div class="tb-title">Production</div>
      <div class="tb-crumb">
  ...
  <div class="body">
    <div class="pg-header">
      <div>
        <div class="pg-heading">Production</div>
        <div class="pg-sub">Kelola produksi konten</div>
      </div>
      <button class="btn btn-primary">
        <i class="fa-solid fa-plus"></i> Tugas Produksi Baru
      </button>
    </div>
    <div class="content-card">
      ...
      <div class="card-body">
        <p>Halaman Production sedang dalam pengembangan.</p>
...
<script>console.log('Production page loaded');</script>
</body>
</html>
<?php /**PATH C:\xampp444\htdocs\laravel\pageflowry\resources\views/admin/production/index.blade.php ENDPATH**/ ?>