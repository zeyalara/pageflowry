...
<title>Pageflowry — Edit Brand</title>
...
/* ────────────────────────────────────
   FORM CARDS
────────────────────────────────── */
.fcard{background:var(--white);border-radius:var(--r);border:1px solid var(--border);box-shadow:var(--s1);overflow:hidden;animation:fadeUp .45s .15s ease both}
...
.form-label{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--text-400)}
.form-input{
  padding:12px 16px;border-radius:var(--rs);border:1px solid var(--border);
  background:var(--white);font-size:14px;color:var(--text-900);transition:var(--t);
  font-family:inherit;
}
...
.form-textarea:focus{outline:none;border-color:var(--blue);box-shadow:0 0 0 3px rgba(88,151,254,.1)}
.form-select{
  padding:12px 16px;border-radius:var(--rs);border:1px solid var(--border);
  background:var(--white);font-size:14px;color:var(--text-900);transition:var(--t);
  font-family:inherit;
}
.form-select:focus{outline:none;border-color:var(--blue);box-shadow:0 0 0 3px rgba(88,151,254,.1)}
.form-error{color:var(--rose);font-size:12px;font-weight:500;margin-top:4px;display:flex;align-items:center;gap:4px}
.form-error::before{content:'!';width:14px;height:14px;border-radius:50%;background:var(--rose);color:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700}
.form-actions{display:flex;gap:12px;margin-top:24px;padding-top:20px;border-top:1px solid var(--border-light)}
...
<div class="shell">
  ...
  <div class="main">
    <header class="topbar">
      <div class="tb-left">
        <div class="tb-title">Edit Brand</div>
        <div class="tb-crumb">
    ...
    <div class="content">
      ...
      <div class="page-head">
        <h1 class="ph-title">Edit Brand</h1>
        <div class="ph-actions">
          <a href="{{ route('brands.show', $brand->id) }}" class="btn btn-secondary">
      ...
      <div class="fcard">
        <div class="fcard-head">
          <div class="fch-l">
            <div class="fch-title">Form Edit Brand</div>
          </div>
        </div>
          ...
          <form action="{{ route('brands.update', $brand->id) }}" method="POST">
            ...
            <div class="form-grid">
              ...
              <div class="form-item">
                ...
                <input type="text" id="pic" name="pic" class="form-input" value="{{ old('pic', $brand->pic) }}" required>
                @error('pic')
                  <div class="form-error">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-item">
                ...
                <input type="text" id="contact" name="contact" class="form-input" value="{{ old('contact', $brand->contact) }}" required>
                @error('contact')
                  <div class="form-error">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-item" style="grid-column: 1 / -1;">
                ...
                <textarea id="target_market" name="target_market" class="form-textarea" rows="3" required>{{ old('target_market', $brand->target_market) }}</textarea>
                @error('target_market')
                  <div class="form-error">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-item" style="grid-column: 1 / -1;">
                ...
                <textarea id="tone" name="tone" class="form-textarea" rows="3" required>{{ old('tone', $brand->tone) }}</textarea>
                @error('tone')
                  <div class="form-error">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-actions">
              <button type="submit" class="btn btn-primary">
                <i class="fa-solid fa-save"></i> Update Brand
              </button>
