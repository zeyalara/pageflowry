...
<title>Pageflowry — Detail Brand</title>
...
/* ────────────────────────────────────
   DETAIL CARDS
────────────────────────────────── */
.dcard{background:var(--white);border-radius:var(--r);border:1px solid var(--border);box-shadow:var(--s1);overflow:hidden;animation:fadeUp .45s .15s ease both}
.dcard-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px 16px;border-bottom:1px solid var(--border-light)}
.dch-l{display:flex;align-items:center;gap:10px}
.dch-title{font-size:14px;font-weight:700;color:var(--text-700)}
.dcard-body{padding:24px}
.detail-grid{display:grid;grid-template-columns:1fr 1fr;gap:24px}
.detail-item{display:flex;flex-direction:column;gap:4px}
.detail-label{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--text-400)}
.detail-value{font-size:15px;font-weight:600;color:var(--text-900)}
.detail-text{font-size:14px;color:var(--text-700);line-height:1.5}
...
<div class="shell">
  ...
  <div class="main">
    <header class="topbar">
      <div class="tb-left">
        <div class="tb-title">Detail Brand</div>
        <div class="tb-crumb">
    ...
    <div class="content">
      ...
      <div class="page-head">
        <h1 class="ph-title">{{ $brand->name }}</h1>
      ...
      <div class="dcard">
        <div class="dcard-head">
          <div class="dch-l">
            <div class="dch-title">Informasi Brand</div>
          </div>
        </div>
        <div class="dcard-body">
          <div class="detail-grid">
            <div class="detail-item">
              <div class="detail-label">Nama Brand</div>
              <div class="detail-value">{{ $brand->name }}</div>
            </div>

            <div class="detail-item">
              <div class="detail-label">PIC</div>
              <div class="detail-value">{{ $brand->pic }}</div>
            </div>

            <div class="detail-item">
              <div class="detail-label">Kontak</div>
              <div class="detail-value">{{ $brand->contact }}</div>
            </div>

            <div class="detail-item">
              <div class="detail-label">Status</div>
              <div class="detail-value">
                <span class="pill {{ $brand->status == 'Active' ? 'p-pub' : 'p-prod' }}">
                  <span class="pdot"></span>{{ $brand->status }}
                </span>
              </div>
            </div>
            ...
            <div class="detail-item full">
              ...
              <div class="detail-text">{{ $brand->target_market }}</div>
            </div>

            <div class="detail-item full">
              <div class="detail-label">Tone & Voice</div>
              <div class="detail-text">{{ $brand->tone }}</div>
            </div>
          </div>
        </div>
      </div>
