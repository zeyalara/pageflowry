...
<head>
  ...
  <title>Edit Content Brief - PAGEFLOWRY</title>
    ...
    <div class="content">
      <div class="form-card">
        <div class="form-header">
          <h2 class="form-title">Edit Content Brief</h2>
          <p class="form-sub">Perbarui brief untuk konten: {{ $brief->title }}</p>
        </div>
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <select id="brand_id" name="brand_id" class="form-select" required>
                  ...
                  @foreach($brands as $brand)
                    <option value="{{ $brand->id }}" {{ old('brand_id', $brief->brand_id) == $brand->id ? 'selected' : '' }}>
                      {{ $brand->name }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select id="creator_id" name="creator_id" class="form-select">
                  ...
                  @foreach($creators as $creator)
                    <option value="{{ $creator->id }}" {{ old('creator_id', $brief->creator_id) == $creator->id ? 'selected' : '' }}>
                      {{ $creator->name }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select id="platform" name="platform" class="form-select" required>
                  <option value="Instagram" {{ old('platform', $brief->platform) == 'Instagram' ? 'selected' : '' }}>Instagram</option>
                  <option value="TikTok" {{ old('platform', $brief->platform) == 'TikTok' ? 'selected' : '' }}>TikTok</option>
                  <option value="YouTube" {{ old('platform', $brief->platform) == 'YouTube' ? 'selected' : '' }}>YouTube</option>
                </select>
                @error('platform')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  name="content_format" 
                  class="form-input" 
                  value="{{ old('content_format', $brief->content_format) }}"
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-input" 
                  value="{{ old('target_duration', $brief->target_duration) }}"
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-input" 
                  value="{{ old('production_deadline', $brief->production_deadline) }}"
                  required
                >
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-input" 
                  value="{{ old('publish_deadline', $brief->publish_deadline) }}"
                  required
                >
            ...
            <div class="form-grid">
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('objective', $brief->objective) }}</textarea>
                @error('objective')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('target_audience', $brief->target_audience) }}</textarea>
              ...
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('key_message', $brief->key_message) }}</textarea>
                @error('key_message')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-grid">
              ...
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('storyline', $brief->storyline) }}</textarea>
                @error('storyline')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('visual_direction', $brief->visual_direction) }}</textarea>
            ...
            <div class="form-grid">
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('caption', $brief->caption) }}</textarea>
                @error('caption')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group full-width">
                ...
                <textarea 
                  ...
                  required
                >{{ old('hashtags', $brief->hashtags) }}</textarea>
                @error('hashtags')
                  <div class="error-message">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input 
                  ...
                  name="target_views" 
                  class="form-input" 
                  value="{{ old('target_views', $brief->target_views) }}"
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-input" 
                  value="{{ old('target_engagement', $brief->target_engagement) }}"
