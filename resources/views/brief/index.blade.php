...
<head>
  ...
  <title>Content Brief - PAGEFLOWRY</title>
      ...
      <div class="table-card">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $brief->creator ? $brief->creator->name : '-' }}</td>
                <td>
                  <span class="platform-badge platform-{{ strtolower($brief->platform) }}">
                    {{ $brief->platform }}
                  </span>
                </td>
                <td>{{ \Carbon\Carbon::parse($brief->publish_deadline)->format('d M Y') }}</td>
                <td>
                ...
                <td>
                  <div class="action-buttons">
                    <a href="{{ route('brief.show', $brief->id) }}" class="btn-action btn-detail">
                    ...
                    <a href="{{ route('brief.edit', $brief->id) }}" class="btn-action btn-edit">
                      <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
          <div class="empty-state">
            ...
            <div class="empty-state-text">Belum ada content brief</div>
            <div class="empty-state-sub">Mulai dengan membuat brief pertama Anda</div>
          </div>
        @endif
      </div>
    </div>
